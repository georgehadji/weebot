...
class TestToolResultEnhanced:
    ...
    def test_success_result_factory(self):
        ...
        result = ToolResult.success_result(
            output="Done", data={"key": "value"}, execution_time_ms=100.0
        )
    ...
    def test_error_result_factory(self):
        ...
        result = ToolResult.error_result(
            error="Failed", output="Partial output", execution_time_ms=50.0
        )
    ...
    def test_to_dict_serialization(self):
        ...
        result = ToolResult.success_result(
            output="Test", data={"nested": {"value": 123}}, execution_time_ms=42.0
        )
...
class TestToolCollectionMetadata:
    ...
    class MockTool(BaseTool):
        ...
        async def execute(self, **kwargs) -> ToolResult:
            return ToolResult.success_result(output="Mock result", data={"input": kwargs})
...
class TestToolResultDataField:
    ...
    def test_data_with_none_values(self):
        ...
        result = ToolResult.success_result(data={"value": None, "other": "present"})
