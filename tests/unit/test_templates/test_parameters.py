...
class TestParameterResolver:
    ...
    def test_string_type_coercion(self, resolver):
        ...
        template = WorkflowTemplate(
            name="Test",
            version="1.0.0",
            parameters={"value": ParameterSchema(name="value", type="string", required=True)},
            workflow={},
        )
    ...
    def test_int_type_validation(self, resolver):
        ...
        template = WorkflowTemplate(
            name="Test",
            version="1.0.0",
            parameters={"count": ParameterSchema(name="count", type="int", required=True)},
            workflow={},
        )
    ...
    def test_bool_type_coercion(self, resolver):
        ...
        template = WorkflowTemplate(
            name="Test",
            version="1.0.0",
            parameters={"flag": ParameterSchema(name="flag", type="bool", required=True)},
            workflow={},
        )
        ...
        template = WorkflowTemplate(
            ...
            parameters={
                "level": ParameterSchema(
                    name="level", type="enum", required=True, enum_values=["low", "medium", "high"]
                )
            },
            workflow={},
        )
    ...
    def test_list_type_parsing(self, resolver):
        ...
        template = WorkflowTemplate(
            name="Test",
            version="1.0.0",
            parameters={"items": ParameterSchema(name="items", type="list", required=True)},
            workflow={},
        )
    ...
    def test_dict_type_parsing(self, resolver):
        ...
        template = WorkflowTemplate(
            name="Test",
            version="1.0.0",
            parameters={"config": ParameterSchema(name="config", type="dict", required=True)},
            workflow={},
        )
