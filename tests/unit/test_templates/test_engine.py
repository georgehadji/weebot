...
class TestTemplateEngineBasic:
    ...
    def sample_template(self):
        return WorkflowTemplate(
            ...
            parameters={"topic": ParameterSchema(name="topic", type="string", required=True)},
            workflow={"task1": {"type": "agent_task", "task": "Research {{topic}}"}},
...
class TestTemplateEngineExecution:
    ...
    def test_execute_with_mock_handler(self):
        ...
        template = WorkflowTemplate(
            ...
            version="1.0",
            parameters={"topic": ParameterSchema(name="topic", type="string", required=True)},
            workflow={"research": {"type": "agent_task", "task": "Research {{topic}}"}},
            output={},
        )
    ...
    def test_dry_run_execution(self):
        ...
        template = WorkflowTemplate(
            name="Dry Run Test",
            version="1.0",
            parameters={"value": ParameterSchema(name="value", type="int", required=True)},
...
class TestTemplateEngineValidation:
    ...
    def test_validate_success(self):
        ...
        template = WorkflowTemplate(
            name="Valid Test",
            version="1.0",
            parameters={"name": ParameterSchema(name="name", type="string", required=True)},
            workflow={"task1": {"type": "agent_task"}},
            output={},
        )
    ...
    def test_validate_missing_handler(self):
        ...
        template = WorkflowTemplate(
            ...
            version="1.0",
            parameters={},
            workflow={"task1": {"type": "unknown_type"}},
            output={},
        )
...
class TestTemplateEngineIntegration:
    ...
    def test_full_workflow_execution(self):
        ...
        template = WorkflowTemplate(
            ...
            parameters={"topic": ParameterSchema(name="topic", type="string", required=True)},
            workflow={
                "research_task": {"type": "research", "task": "Research {{topic}}"},
                "analysis_task": {"type": "analysis", "depends_on": ["research_task"]},
            },
            output={"summary": "Research on {{topic}} completed"},
        )
...
class TestTemplateEngineErrorHandling:
    ...
    def test_task_handler_exception(self):
        ...
        template = WorkflowTemplate(
            ...
            version="1.0",
            parameters={},
            workflow={"task1": {"type": "failing_task"}},
            output={},
        )
        ...
        assert result.success is False or any(not r["success"] for r in result.task_results)
