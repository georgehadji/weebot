...
class TestTemplateRegistrySearch:
    ...
    def test_filter_by_parameter(self, populated_registry):
        ...
        template_with_param = WorkflowTemplate(
            ...
            version="1.0",
            parameters={
                "special_param": ParameterSchema(name="special_param", type="string", required=True)
            },
            workflow={},
        )
...
class TestTemplateRegistryMetadata:
    ...
    def registry_with_templates(self):
        ...
        template = WorkflowTemplate(
            ...
            author="Developer",
            parameters={
                "param1": ParameterSchema(name="param1", type="string", required=True),
                "param2": ParameterSchema(name="param2", type="int", required=False, default=42),
            },
            workflow={},
        )
