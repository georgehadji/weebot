...
export interface ToolFunctionWithGenerator<TInput extends $ZodObject<$ZodShape>, TEvent extends $ZodType = $ZodType<unknown>, TOutput extends $ZodType = $ZodType<unknown>, TContext extends Record<string, unknown> = Record<string, unknown>, TName extends string = string> extends BaseToolFunction<TInput> {
    eventSchema: TEvent;
    outputSchema: TOutput;
    execute: (params: zodInfer<TInput>, context?: ToolExecuteContext<TName, TContext>) => AsyncGenerator<zodInfer<TEvent> | zodInfer<TOutput>, zodInfer<TOutput> | undefined>;
    /** Convert tool execution output to model-facing output */
    toModelOutput?: ToModelOutputFunction<zodInfer<TInput>, zodInfer<TOutput>>;
}
/**
 ...
 */
export interface HITLToolFunction<TInput extends $ZodObject<$ZodShape>, TOutput extends $ZodType = $ZodType<unknown>, TContext extends Record<string, unknown> = Record<string, unknown>, TName extends string = string> extends BaseToolFunction<TInput> {
    /**
     ...
     */
    outputSchema: TOutput;
    onToolCalled: (params: zodInfer<TInput>, context?: ToolExecuteContext<TName, TContext>) => Promise<zodInfer<TOutput> | null> | zodInfer<TOutput> | null;
    onResponseReceived?: (rawResult: unknown, context?: ToolExecuteContext<TName, TContext>) => Promise<zodInfer<TOutput>> | zodInfer<TOutput>;
    toModelOutput?: ToModelOutputFunction<zodInfer<TInput>, zodInfer<TOutput>>;
}
/**
 ...
 */
export type HITLTool<TInput extends $ZodObject<$ZodShape> = $ZodObject<$ZodShape>, TOutput extends $ZodType = $ZodType<unknown>, TContext extends Record<string, unknown> = Record<string, unknown>> = {
    type: ToolType.Function;
 ...
 */
export type ClientTool = ToolWithExecute<$ZodObject<$ZodShape>, $ZodType<unknown>> | ToolWithGenerator<$ZodObject<$ZodShape>, $ZodType<unknown>, $ZodType<unknown>> | ManualTool<$ZodObject<$ZodShape>, $ZodType<unknown>> | HITLTool<$ZodObject<$ZodShape>, $ZodType<unknown>>;
/**
 ...
 */
export type ServerToolConfig = Exclude<models.ResponsesRequestToolUnion, {
    type: 'function';
}>;
/**
...
export interface ServerTool<T extends ServerToolType = ServerToolType> extends ServerToolBase {
    readonly config: Extract<ServerToolConfig, {
        type: T;
    }>;
}
/**
 ...
 */
export type ServerToolResultItem = Exclude<models.OutputItems, {
    type: 'message';
} | {
    type: 'reasoning';
} | {
 ...
 */
export declare function isServerTool(tool: Tool): tool is ServerTool;
/**
 * Type guard: true if the tool is a client-executed tool (function, generator, or manual).
 */
export declare function isClientTool(tool: Tool): tool is ClientTool;
/**
 ...
 */
export declare function isHITLTool(tool: Tool): tool is HITLTool;
/**
 ...
 */
export declare function isAutoResolvableTool(tool: Tool): tool is ToolWithExecute | ToolWithGenerator | HITLTool;
/**
 ...
 *   before resuming
 */
export type ConversationStatus = 'complete' | 'interrupted' | 'awaiting_approval' | 'awaiting_hitl' | 'in_progress';
/**
...
] ? ToolHasApproval<First> extends true ? true : HasApprovalTools<Rest> : false;
/**
