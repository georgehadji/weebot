...
import type { HITLTool, ManualTool, NextTurnParamsFunctions, ServerTool, ServerToolConfig, ServerToolType, ToModelOutputFunction, Tool, ToolApprovalCheck, ToolExecuteContext, ToolWithExecute, ToolWithGenerator } from './tool-types.js';
/**
 ...
 */
type HITLToolConfig<TInput extends $ZodObject<$ZodShape>, TOutput extends $ZodType, TContext extends Record<string, unknown> = Record<string, unknown>, TName extends string = string> = {
    name: TName;
    description?: string;
    inputSchema: TInput;
    /**
...
export declare function tool<TInput extends $ZodObject<$ZodShape>, TOutput extends $ZodType, TContext extends Record<string, unknown> = Record<string, unknown>, TName extends string = string>(config: HITLToolConfig<TInput, TOutput, TContext, TName>): HITLTool<TInput, TOutput, TContext>;
