...
export function callModel(client, request, options) {
    ...
    const { tools, stopWhen, state, requireApproval, approveToolCalls, rejectToolCalls, context, sharedContextSchema, onTurnStart, onTurnEnd, allowFinalResponse, ...apiRequest } = request;
