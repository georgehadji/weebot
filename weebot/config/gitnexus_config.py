...
class GitNexusConfig:
    ...
    analysis_modes: list[str] = field(
        default_factory=lambda: ["structure", "parsing", "resolution", "clustering", "processes"]
    )
    ...
    def __post_init__(self):
        ...
        self.skip_embeddings = (
            os.getenv("GITNEXUS_SKIP_EMBEDDINGS", str(self.skip_embeddings)).lower() == "true"
        )
        self.force_reindex = (
            os.getenv("GITNEXUS_FORCE_REINDEX", str(self.force_reindex)).lower() == "true"
        )
        ...
        self.enable_caching = (
            os.getenv("GITNEXUS_ENABLE_CACHING", str(self.enable_caching)).lower() == "true"
        )
        ...
        self.auto_analyze_on_startup = (
            os.getenv("GITNEXUS_AUTO_ANALYZE", str(self.auto_analyze_on_startup)).lower() == "true"
        )


# Global configuration instance
_gitnexus_config: GitNexusConfig | None = None
