...
MODELS: dict[str, ModelConfig] = {
    ...
    "allenai/olmo-3-32b-think": ModelConfig(
        ...
        strengths=[TaskType.CHAT, TaskType.CODE_REVIEW, TaskType.REASONING, TaskType.REASONING, TaskType.DOCUMENTATION, TaskType.ARCHITECTURE],
        tier=ModelTier.STANDARD,
        api_key_env="OPENROUTER_API_KEY",
        tool_use_score=5,
    ),
    ...
    "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free": ModelConfig(
        ...
        cost_per_1k_tokens=0.0,
        context_window=256000,
        strengths=[TaskType.CHAT, TaskType.CREATIVE, TaskType.CODE_REVIEW, TaskType.REASONING, TaskType.REASONING, TaskType.DOCUMENTATION, TaskType.ARCHITECTURE],
        tier=ModelTier.FAST,
        api_key_env="OPENROUTER_API_KEY",
        tool_use_score=5,
    ),
