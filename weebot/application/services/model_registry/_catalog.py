...
MODELS: dict[str, ModelConfig] = {
        ...
        "z-ai/glm-ocr": ModelConfig(
            name="GLM OCR",
            provider="openrouter",
            cost_per_1k_tokens=0.0001,
            context_window=131072,
            strengths=[TaskType.DOCUMENTATION, TaskType.ANALYSIS],
            tier=ModelTier.STANDARD,
            api_key_env="OPENROUTER_API_KEY",
        ),
        "z-ai/glm-image": ModelConfig(
            name="GLM Image",
            provider="openrouter",
        ...
        "z-ai/glm-agent-slide": ModelConfig(
            name="GLM Slide Agent",
            provider="openrouter",
            cost_per_1k_tokens=0.0007,
            context_window=131072,
            strengths=[TaskType.CREATIVE, TaskType.AGENTIC],
            tier=ModelTier.STANDARD,
            api_key_env="OPENROUTER_API_KEY",
        ),
        "z-ai/glm-agent-translation": ModelConfig(
            name="GLM Translation Agent",
            provider="openrouter",
        ...
        "z-ai/glm-agent-video-template": ModelConfig(
            name="GLM Video Effect Agent",
            provider="openrouter",
            cost_per_1k_tokens=0.2,
            context_window=4096,
            strengths=[TaskType.CREATIVE],
        ...
        "x-ai/grok-voice-latest": ModelConfig(
            name="Grok Voice Agent (Latest)",
            provider="xai",
            cost_per_1k_tokens=0.015,
            context_window=131072,
            strengths=[TaskType.CHAT, TaskType.AGENTIC],
            tier=ModelTier.STANDARD,
            api_key_env="XAI_API_KEY",
        ),
        "x-ai/grok-voice-think-fast-1.0": ModelConfig(
            name="Grok Voice Agent (Think Fast 1.0)",
            provider="xai",
            cost_per_1k_tokens=0.02,
            context_window=131072,
            strengths=[TaskType.CHAT, TaskType.REASONING, TaskType.AGENTIC],
            tier=ModelTier.STANDARD,
            api_key_env="XAI_API_KEY",
        ),
        "x-ai/grok-imagine-video-1.5": ModelConfig(
        ...
        "x-ai/grok-4.3": ModelConfig(
            ...
            cost_per_1k_tokens=0.002,
            context_window=131072,
            strengths=[TaskType.AGENTIC, TaskType.ANALYSIS, TaskType.CHAT, TaskType.CODE_GENERATION, TaskType.DEBUGGING, TaskType.DOCUMENTATION, TaskType.REASONING],
            tier=ModelTier.STANDARD,
            api_key_env="XAI_API_KEY",
        ),
        "x-ai/grok-4.20-multi-agent": ModelConfig(
            ...
            cost_per_1k_tokens=0.005,
            context_window=131072,
            strengths=[TaskType.AGENTIC, TaskType.REASONING],
            tier=ModelTier.STANDARD,
            api_key_env="XAI_API_KEY",
        ),
