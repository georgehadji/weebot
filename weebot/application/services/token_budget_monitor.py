...
class TokenBreakdown:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "usage_percent": (
                round((self.total_used / self.max_capacity) * 100, 1)
...
class TokenBudgetMonitor:
    ...
    def get_status(self, breakdown: TokenBreakdown) -> str:
        ...
        """
        usage_ratio = (
            breakdown.total_used / breakdown.max_capacity if breakdown.max_capacity > 0 else 0
        )
    ...
    def get_recommendation(self, breakdown: TokenBreakdown) -> str | None:
        ...
        if status == "critical":
            ...
            return (
                f"Context usage at {breakdown.to_dict()['usage_percent']:.0f}%. Monitor for growth."
            )
        return None
    ...
    def estimate_time_to_limit(self, session_id: str, max_tokens: int = 128000) -> float | None:
