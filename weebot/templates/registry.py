...
class TemplateRegistry:
    ...
    def search(self, query: str) -> list[WorkflowTemplate]:
        ...
        for template in self._templates.values():
            if (
                ...
                or query_lower in template.author.lower()
            ):
    ...
    def filter_by_author(self, author: str) -> list[WorkflowTemplate]:
        ...
        return [t for t in self._templates.values() if t.author.lower() == author.lower()]

    def filter_by_parameter(self, param_name: str) -> list[WorkflowTemplate]:
        """Get all templates that have a specific parameter."""
        return [t for t in self._templates.values() if param_name in t.parameters]
    ...
    def load_from_directory(self, directory: Union[str, Path], pattern: str = "*.yaml") -> int:
        """
