...
AGENT_CAPABILITIES: dict[SubAgentRole, AgentCapability] = {
    SubAgentRole.RESEARCHER: AgentCapability(
        ...
        preferred_models=["minimax/minimax-m3", "qwen/qwen3.8-max-0902"],
        max_concurrency=4,
        max_tool_calls=20,
    ),
    SubAgentRole.ANALYST: AgentCapability(
        ...
        preferred_models=["qwen/qwen3.8-max-0902", "minimax/minimax-m3"],
        max_concurrency=2,
        max_tool_calls=15,
    ),
    SubAgentRole.CODER: AgentCapability(
        ...
        preferred_models=["qwen/qwen3.8-max-0902", "deepseek/deepseek-v4-pro"],
        max_concurrency=2,
        max_tool_calls=30,
    ),
