...
% Engine: XeLaTeX or LuaLaTeX (both verified). Do NOT compile with pdfLaTeX.
% Build:  latexmk -xelatex  -shell-escape main.tex
%    or:  latexmk -lualatex -shell-escape main.tex
% LuaLaTeX needs the texlive-luatex runtime (luatexbase + luaotfload); the
% fontspec/polyglossia setup below is otherwise engine-agnostic.
%
