...
class ErrorHandler:
    ...
    def _wrap_exception(self, error: Exception, operation: str) -> WeebotError:
...
def handle_errors(
    operation: str = "operation", reraise: bool = True, default_return: T | None = None
) -> Callable:
    """
...
def handle_async_errors(
    operation: str = "async operation", reraise: bool = True, default_return: T | None = None
) -> Callable:
...
@contextmanager
def error_boundary(operation: str, correlation_id: str | None = None, suppress: bool = False):
    """
...
class ErrorAggregator:
    ...
    @contextmanager
    def catch(self, item_identifier: str | None = None):
        ...
        try:
            ...
            weebot_error = handler.handle(
                ...
                operation=(
                    f"{self.operation}:{item_identifier}" if item_identifier else self.operation
                ),
            )
